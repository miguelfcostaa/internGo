...
const EditarEstagio = () => {
  ...
  const { id } = useParams(); // ID do estágio
  const [companyId, setCompanyId] = useState(""); // ID da empresa logada
    ...
    const carregarEstagio = async () => {
      try {
        ...
        const response = await fetch(
          `http://localhost:5000/api/estagios/${id}`,
          {
            method: "GET",
            headers: {
        ...
        setFormData({
          ...
          prazoCandidatura: estagio.prazoCandidatura
            ? estagio.prazoCandidatura.slice(0, 10)
            : "",
  ...
  // Obter ID da empresa logada do token
  useEffect(() => {
    const token = localStorage.getItem("token");
    if (token) {
      const payload = JSON.parse(atob(token.split(".")[1]));
      const companyIdFromToken = payload.id;
  ...
  const handleAtualizarEstagio = async () => {
    ...
    try {
      ...
      if (request.ok) {
        setSuccess(true);
        // Sinalizar que um estágio foi atualizado
        localStorage.setItem("estagioUpdated", "true");
        setTimeout(() => {
    ...
    <>
      ...
      <Container className="mt-5">
        <div className={`${style.container} ${style.mt4}`}>
          <div
            className={`${style.mb4} ${style.borderBottom} ${style.pb2}`}
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  className={`${style.input} ${
                    formData.title.length > 60 ? "is-invalid" : ""
                  }`}
                />
                <div className="d-flex justify-content-between">
                  {formData.title.length > 60 && (
                    <span className={style.charterror}>
                      Máximo de 60 caracteres ultrapassado!
                    </span>
                  )}
                  <small
                    className={`ms-auto ${
                      formData.title.length > 60 ? "text-danger" : "text-muted"
                    }`}
                  >
              ...
              <Form.Group className="mb-3">
                ...
                <div className="d-flex justify-content-between">
                  {formData.area.length > 30 && (
                    <span className={style.charterror}>
                      Máximo de 30 caracteres ultrapassado!
                    </span>
                  )}
                  <small
                    className={`ms-auto ${
                      formData.area.length > 30 ? "text-danger" : "text-muted"
                    }`}
                  >
                ...
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      ...
                      className={`${style.input} ${
                        formData.localizacao.length > 40 ? "is-invalid" : ""
                      }`}
                    />
                    <div className="d-flex justify-content-between">
                      {formData.localizacao.length > 40 && (
                        <span className={style.charterror}>
                          Máximo de 40 caracteres ultrapassado!
                        </span>
                      )}
                      <small
                        className={`ms-auto ${
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  className={`${style.textarea} ${
                    formData.descricao.length > 500 ? "is-invalid" : ""
                  }`}
                />
                <div className="d-flex justify-content-between">
                  {formData.descricao.length > 500 && (
                    <span className={style.charterror}>
                      Máximo de 500 caracteres ultrapassado!
                    </span>
                  )}
                  <small
                    className={`ms-auto ${
              ...
              <Form.Group className="mb-3">
                ...
                <div className="d-flex justify-content-between">
                  {formData.beneficios.length > 300 && (
                    <span className={style.charterror}>
                      Máximo de 300 caracteres ultrapassado!
                    </span>
                  )}
                  <small
                    className={`ms-auto ${
              ...
              <Form.Group className="mb-3">
                ...
                <div className="d-flex justify-content-between">
                  {formData.cursosPreferenciais.length > 200 && (
                    <span className={style.charterror}>
                      Máximo de 200 caracteres ultrapassado!
                    </span>
                  )}
                  <small
                    className={`ms-auto ${
          ...
          {step === 3 && (
            <div>
              ...
              <Form.Group className="mb-3">
                ...
                />
                <div className="d-flex justify-content-between">
                  {Array.isArray(formData.competenciasTecnicas) &&
                  ...
                  >
                    {Array.isArray(formData.competenciasTecnicas)
                      ? formData.competenciasTecnicas.length
                      : 0}
                    /300 caracteres
                  </small>
                </div>
                  ...
                  <Form.Group className="mb-3">
                    ...
                    <div className="d-flex justify-content-between">
                      {formData.idiomas.length > 150 && (
                        <span className={style.charterror}>
                          Máximo de 150 caracteres ultrapassado!
                        </span>
                      )}
                      <small
                        className={`ms-auto ${
                ...
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      ...
                      className={`${style.input} ${
                        formData.observacoes.length > 150 ? "is-invalid" : ""
                      }`}
                    />
                    <div className="d-flex justify-content-between">
            ...
            <div>
              ...
              >
                <div style={{ flex: "1 1 45%" }}>
                  ...
                  <p>
                    <strong>Prazo de Candidatura:</strong>{" "}
                    {formData.prazoCandidatura || (
                      <span style={{ color: "#aaa" }}> Não especificado.</span>
                    )}
                  </p>
                </div>
                <div style={{ flex: "1 1 45%" }}>
                  ...
                  <p>
                    ...
                    {formData.cursosPreferenciais ? (
                      formData.cursosPreferenciais.join(", ")
                    ) : (
                      <span style={{ color: "#aaa" }}> Não especificado.</span>
                    )}
                  </p>
                  <p>
                    <strong>Habilitações Mínimas:</strong>{" "}
                    {formData.habilitacoesMinimas || (
                      <span style={{ color: "#aaa" }}> Não especificado.</span>
                    )}
                  </p>
                  <p>
                    ...
                    {formData.competenciasTecnicas ? (
                      formData.competenciasTecnicas.join(", ")
                    ) : (
                      <span style={{ color: "#aaa" }}> Não especificado.</span>
                    )}
                  </p>
                  <p>
                    ...
                    {formData.competenciasPessoais ? (
                      formData.competenciasPessoais.join(", ")
                    ) : (
                      <span style={{ color: "#aaa" }}> Não especificado.</span>
                    )}
                  </p>
      ...
      <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)}>
        ...
        <Modal.Body>
          Tem certeza que deseja deletar este estágio? Esta ação não pode ser
          desfeita.
        </Modal.Body>
        <Modal.Footer>
