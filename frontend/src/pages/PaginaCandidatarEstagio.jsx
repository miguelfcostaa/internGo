          ...
          <div className={style.bigbox}>
            <form onSubmit={handlesSubmit}>
              ...
              >
                <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <div className={style.formrow}>
                    ...
                    <label className={style.labelcoluna}>
                      ...
                      >
                        <option value="">
                          Escolha o seu nível de habilitação
                        </option>
                        <option value="1">
                          Nível 1 - 4º Ano do Ensino Básico
                        </option>
                        <option value="2">
                          Nível 2 - 6º Ano do Ensino Básico
                        </option>
                        <option value="3">
                          Nível 3 - 9º Ano do Ensino Básico
                        </option>
                        <option value="4">
                          Nível 4 - Ensino Secundário + Estágio Profissional
                        </option>
                        <option value="5">
                          Nível 5 - Cursos de Especialização Tecnólogica (CET)
                        </option>
                ...
                <label className={style.labelcoluna}>
                  Escreva a sua carta de Apresentação:
                  <textarea
